...
import RegisterArt from './pages/RegisterArt'; // Import the new page
    ...
    <Router>
      <Routes>
        ...
        <Route path="/artists" element={<><Navbar /><main className="grow w-full"><Artists /></main></>} />
         ...
         {/* Updated Route */}
         <Route path="/register-art" element={<><Navbar /><main className="grow w-full"><RegisterArt /></main></>} />
         
         <Route path="/exhibit/:id" element={<><Navbar /><main className="container mx-auto px-4 py-8"><ExhibitDetails /></main></>} />
         <Route path="/artist/:name" element={<><Navbar /><main className="grow w-full"><ArtistDetails /></main></>} />
